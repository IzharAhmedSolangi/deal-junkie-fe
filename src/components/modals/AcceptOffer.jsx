              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-[16px] bg-white text-left shadow-xl transition-all md:w-[600px] w-full md:py-12 md:px-6 p-5">
                ...
                <div className="flex flex-col justify-center items-center w-full">
                  ...
                  <div className="flex items-center justify-center gap-2 mt-5">
                    ...
                    <button
                      className="button-2 bg-primary border border-primary cursor-pointer w-[130px] h-[40px] text-white rounded flex justify-center items-center"
                      onClick={handleConfirmCancel}
                      disabled={loading}
                    >
                      {loading ? <ButtonLoader1 /> : "Accept"}
                    </button>
                  </div>
                </div>
              </Dialog.Panel>
