      ...
      <div className="w-full p-5 bg-white rounded-xl shadow-lg">
        <div className="flex flex-col items-center">
          ...
          <div className="flex items-center gap-1 mt-2">
            <MdOutlineLocationOn className="text-[#6F7487] md:text-[20px] text-[15px] flex-shrink-0" />
          ...
          <div className="flex items-center gap-1 mt-2">
            <FaLinkedin className="text-[#6F7487] md:text-[20px] text-[15px] flex-shrink-0" />
            <a
          ...
          <div className="flex items-center gap-1 mt-2">
            <MdOutlineMail className="text-[#6F7487] md:text-[20px] text-[15px] flex-shrink-0" />
            <p className="font-normal text-[15px] text-[#6F7487]">
              {findJob.data?.user?.email}
            </p>
          </div>
          <div className="flex items-center gap-1 mt-2">
            <MdPhoneAndroid className="text-[#6F7487] md:text-[20px] text-[15px] flex-shrink-0" />
            <p className="font-normal text-[15px] text-[#6F7487]">
