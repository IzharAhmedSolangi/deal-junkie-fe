...
import useUnblockUser from "../../../services/admin/useUnblockUser";

function Unblock(props) {
  const { isOpenModal, setIsOpenModal, icon, title, description, userId } =
    props;
  const cancelButtonRef = useRef(null);
  const { unblockUser, UnblockUser } = useUnblockUser();
  ...
  const handleConfirm = () => {
    UnblockUser(userId, handleClose);
  };
                ...
                <div className="flex flex-col justify-center items-center w-full">
                  ...
                  <div className="flex items-center justify-center gap-2 mt-5">
                    ...
                    <button
                      ...
                      disabled={unblockUser.loading}
                    >
                      {unblockUser.loading ? <ButtonLoader1 /> : "Unblock"}
                    </button>
                  </div>
                </div>
              </Dialog.Panel>
